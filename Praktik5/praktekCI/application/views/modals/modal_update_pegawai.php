  ...
  <form method="POST" id="form-update-pegawai">
    ...
    <div class="input-group form-group">
      ...
      <select name="kota" class="form-control select2" aria-describedby="sizing-addon2">
        ...
        ?>
          <option value="<?php echo $kota->id; ?>" <?php if ($kota->id == $dataPegawai->id_kota) {
    ...
    <div class="input-group form-group" style="display: inline-block;">
      ...
      <span class="input-group-addon">
        <input type="radio" name="jk" value="1" id="laki" class="minimal" <?php if ($dataPegawai->id_kelamin == 1) {
                                                                            echo "checked='checked'";
                                                                          } ?>>
        <label for="laki">Laki-laki</label>
      </span>
      <span class="input-group-addon">
        <input type="radio" name="jk" value="2" id="perempuan" class="minimal" <?php if ($dataPegawai->id_kelamin == 2) {
                                                                                  echo "checked='checked'";
                                                                                } ?>>
    ...
    <div class="input-group form-group">
      ...
      <select name="posisi" class="form-control select2" aria-describedby="sizing-addon2">
        ...
        ?>
          <option value="<?php echo $posisi->id; ?>" <?php if ($posisi->id == $dataPegawai->id_posisi) {
                                                        echo "selected='selected'";
